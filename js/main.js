...
const FALLBACK_DATA = {
  ...
  "modules": [
    ...
    },
    {
      ...
      "evidence": [
        { "title": "Thiết lập kênh giao tiếp đa phương thức: Kết hợp trao đổi nhanh qua Zalo và họp trực tuyến qua Google Meet để giải quyết vấn đề kịp thời, đảm bảo dự án luôn hoàn thành trước thời hạn với chất lượng tối ưu.", "type": "image", "dataId": "img/evidence_4_1.png" },
